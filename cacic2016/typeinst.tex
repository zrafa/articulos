...
Durante dicho análisis, el mayor costo en tiempo de ejecución es el del algoritmo LSD, que es de orden de tiempo lineal [REFERENCIA]. En base a esto, y al hecho de que las fotos poseen la misma resolución y, que el número de de fibras analizadas en cada medición es menor a 15 (un mayor numero de fibras distorsionaría los resultados), el tiempo de ejecución de cada medición ha sido determinado, luego de analizar 96 muestras, en un rango (0seg..3seg].

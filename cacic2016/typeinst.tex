...
que analiza la imagen digital y reporta los resultados. Contiene un SOC principal Allwinner A10, con una CPU ARM de 700Mhz. La memoria principal (RAM) es de 512MB, y tambien cuenta con una interfaz de memoria SD en donde se ha incorporado una tarjeta microSD de 2GB. El bootloader del SOC carga, al momento de reset, el sistema
operativo desde la memoria microSD, y luego el sistema operativo ejecuta
la aplicación prototipo final.
EL SOC Allwinner tambien cuenta, internamente, con dispositivos de E/S (GPIO), un puerto USB 2.0, y una interfaz Wireless WiFi 802.11b/g/n.

El tamaño del hardware embebido es de 10cmx4cmx3cm y el del dispositivo portatil es de 20cmx20cmx5cm. El peso total de todo el equipamiento es de 900gr. Estas caracterísitcas posibilitan que el operador pueda utilizar el equipamiento a mano alzada, tomando capturas de las muestras de fibra directamente sobre el animal en campo.
...
\caption{Izq: Una imágen artificial. Der: Mediciones realizadas a las imágenes.}

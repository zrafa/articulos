...
\begin{figure}
\centering
\includegraphics[height=4cm]{prototipovswv}
...
\begin{figure}
\centering
\includegraphics[height=4cm]{histograma}
...
\bibitem{laserscan} Sirolan Laserscan instrument, \url{http://www.itecinnovation.com/productDetails.php?id=52}

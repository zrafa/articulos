...
En nuestro caso de estudio, al desmontar el ENTC-1000 (ver la Figura ~\ref{fig:placa-encore} ), identificamos
...
de dos sistemas Linux embebidos completos de reemplazo: Amstrong y Debian.
La documentación para preparar sistemas Linux embebidos es amplia y públicamente
disponible (referencias). Como un extra, tambien existen decenas de distribuciones Linux para embebidos,
...
Una vez que se tiene el estudio completo en como construir (compilar y configurar)
...
Además, conocer como preparar un sistema operativo completo de reemplazo permitirá
reusar el hardware en el futuro con propósitos específicos.


Conocer los componentes de software de un sistema Linux embebido posibilita,
en el proceso, estudiar algun método de acceso al sistema original, y tambien

, para entender y modificar un sistema
Linux embebido, conocer la arquitectura de sotware. Por al menos dos motivos :
\begin{enumerate}
 \item Permite obtener los conocimientos necesarios para entender y acceder
    al sistema del firmware original (via conexiones de software)
 \item Permite preparar todo un ambiente de desarrollo de Linux embebido,

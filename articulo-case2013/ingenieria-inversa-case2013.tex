...
(generalmente uClibc o eglibc), y busybox (referencia: pequeño programa ejecutable
optimizado para sistemas embebidos, el cual puede operar como lo hacen
muchas de las utilidades UNIX básicas).
...
Las aplicaciones muchas veces no son de interés, pero si
existiesen drivers del fabricante, comunmente de codigo cerrado,
encontes las chances de contar con las mismas características en una versión preparada
es dificultosa.
No encontramos drivers de código cerrado en nuestra experienica aquí expuesta, por lo
que este punto está fuera del alcance de este artículo.

...
During our work with ENTC-1000, the pins of the UART were not identified or labeled, but present. We identified several ground (GND) and voltage (VCC) pins by means of a multimeter. Then, using the GND pin, the rest of the exposed pins in the board were tested to try to identify transmission (TX) and reception (RX) lines.
  
We found several candidates pins, so then but four of them were 

...
Such complexity comes along with the need to have the device run an operating system, as several functionalities need to be concurrently managed. Vendors opt for Linux in many cases due to low cost and easy customization [REF ELECTROLUX BRAZIL ANDROID ROUTER].
...
For example, the works using Nintendo Game Boy, Zaurus SL-5000 and Chumby devices,
...
\bibitem{electrolux}
Electrolux Brazi, \emph{The Electrolux Infinity I-Kitchen refrigerator}.\hskip 1em plus
